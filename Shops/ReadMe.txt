...
Veritabanın olusturulması ıcın appsettıngs.json da connection bilgilerini değiştirerek update-database edilmesi gerekmektedir.(Kayıt atılması gereken alanlar CustomersRole ve Authorize test edilmek istenirse UserRole)
