...
namespace Shops.Helper
{
    ...
    public class GenericResponse<T>
    {
        ...
        public GenericResponse(ResultType resultType) : this((resultType == ResultType.Success), resultType, string.Empty, default(T), 0)
        {
        }
        ...
        public static GenericResponse<T> Ok(T value, string message)
        {
            return new GenericResponse<T>(true, ResultType.Success, message, value, 1);
        }
        public static GenericResponse<T> OkList(T value, string message, PagingFilter paging)
        {
